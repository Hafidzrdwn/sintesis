...
const validateStep = (step) => {
    ...
    if (step === 1) {
        ...
        if (!form.university.trim()) {
            stepErrors.value.university = 'Nama sekolah/universitas wajib diisi.';
        }
    }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10 pb-16 overflow-hidden">
        ...
        <div v-if="currentJob"
            ...
            <button @click="selectedJobId = ''" 
                class="text-slate-400 hover:text-red-500 transition-colors p-2 cursor-pointer" 
                title="Ganti posisi">
        ...
        <div v-else class="mb-8 bg-amber-50 border border-amber-200 rounded-2xl p-6">
            <div class="flex items-start gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-amber-700 text-sm mt-1">Silakan pilih posisi magang yang ingin Anda lamar dari daftar di bawah ini.</p>
                </div>
            </div>
        ...
        <form @submit.prevent="submit"
                    ...
                    <template v-for="(step, idx) in steps" :key="step.number">
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all"
                                ...
                                <span v-if="currentStep > step.number" class="material-symbols-outlined text-lg">check</span>
            ...
            <div v-show="currentStep === 1" class="p-8 border-b border-slate-100 animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <p v-if="stepErrors.full_name || form.errors.full_name" class="text-red-500 text-sm mt-1">{{ stepErrors.full_name || form.errors.full_name }}</p>
                    </div>
                    <div>
                        ...
                        <p v-if="stepErrors.email || form.errors.email" class="text-red-500 text-sm mt-1">{{ stepErrors.email || form.errors.email }}</p>
                    </div>
                    <div>
                        ...
                        <p v-if="stepErrors.phone || form.errors.phone" class="text-red-500 text-sm mt-1">{{ stepErrors.phone || form.errors.phone }}</p>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Sekolah / Universitas <span class="text-red-500">*</span></label>
                        <div class="relative">
                            ...
                            <input v-model="form.university"
                                class="w-full h-12 pl-10 pr-4 bg-slate-50 border rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-slate-400"
                                :class="stepErrors.university || form.errors.university ? 'border-red-500' : 'border-slate-300'"
                                placeholder="Nama instansi pendidikan" type="text" />
                        </div>
                        <p class="text-slate-400 text-xs mt-1">Tulis nama lengkap tanpa singkatan, contoh: "Universitas Airlangga" bukan "UNAIR"</p>
                        <p v-if="stepErrors.university || form.errors.university" class="text-red-500 text-sm mt-1">{{ stepErrors.university || form.errors.university }}</p>
                    </div>
                    <div>
            ...
            <div v-show="currentStep === 3" class="p-8 border-b border-slate-100 animate-fade-in-up">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p v-if="stepErrors.self_description || form.errors.self_description" class="text-red-500 text-sm mt-1">{{ stepErrors.self_description || form.errors.self_description }}</p>
                    </div>
                    <div>
            ...
            <div v-show="currentStep === 4" class="p-8 bg-slate-50/50 animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Rencana Tanggal Mulai <span class="text-red-500">*</span></label>
                        <div class="relative">
                        ...
                        <p v-if="stepErrors.start_date || form.errors.start_date" class="text-red-500 text-sm mt-1">{{ stepErrors.start_date || form.errors.start_date }}</p>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Rencana Tanggal Berakhir <span class="text-red-500">*</span></label>
                        <div class="relative">
                        ...
                        <p v-if="stepErrors.end_date || form.errors.end_date" class="text-red-500 text-sm mt-1">{{ stepErrors.end_date || form.errors.end_date }}</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="group relative">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Surat Izin Magang <span class="text-red-500">*</span></label>
                        ...
                        <p v-if="stepErrors.letter_file || form.errors.letter_file" class="text-red-500 text-sm mt-1">{{ stepErrors.letter_file || form.errors.letter_file }}</p>
                    </div>
                    <div class="group relative">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Kartu Pelajar / KTM <span class="text-red-500">*</span></label>
                        ...
                        <p v-if="stepErrors.id_card_file || form.errors.id_card_file" class="text-red-500 text-sm mt-1">{{ stepErrors.id_card_file || form.errors.id_card_file }}</p>
                    </div>
                    <div class="group relative">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">CV / Resume Terbaru <span class="text-red-500">*</span></label>
                        ...
                        <p v-if="stepErrors.cv_file || form.errors.cv_file" class="text-red-500 text-sm mt-1">{{ stepErrors.cv_file || form.errors.cv_file }}</p>
                    </div>
                </div>
