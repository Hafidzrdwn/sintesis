...
const form = useForm({
    // Step 1: Identitas
    name: (authUser.value.name) ? authUser.value.name : '',
    email: (authUser.value.email) ? authUser.value.email : '',
    whatsapp: '',
    school: '',
    referral: '',
...
const submit = () => {
    form.post(route('internship.apply'), {
        forceFormData: true,
    });
};
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10 pb-16 overflow-hidden">
        ...
        <div
            ...
            <div>
                ...
                <h3 class="text-xl md:text-2xl font-bold text-slate-900 leading-tight">Mendaftar untuk Posisi: Frontend
                    Developer Intern</h3>
            </div>
        </div>
        ...
        <form @submit.prevent="submit"
            ...
            <div v-show="currentStep === 1" class="p-8 border-b border-slate-100 animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span
                                class="material-symbols-outlined absolute left-3 top-3 text-slate-400 text-[20px]">school</span>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                            <label v-for="os in ['Windows', 'Linux (Ubuntu/etc)', 'macOS']" :key="os"
                                class="flex items-center gap-2 p-3 bg-white border border-slate-200 rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
                                <input v-model="form.os" :value="os"
                                    class="w-4 h-4 text-primary border-slate-300 rounded focus:ring-primary"
                                    type="checkbox" />
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.self_description"
                            class="w-full p-4 h-32 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none transition-all placeholder:text-slate-400"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input v-model="form.portfolio_link"
                                class="w-full h-12 pl-10 pr-4 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-slate-400"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input v-model="form.start_date"
                                class="w-full h-12 px-4 bg-white border border-slate-300 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary text-slate-700"
                                type="date" />
                        </div>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="group relative">
                        ...
                        <div @click="triggerFileInput('letter_input')"
                            class="border-2 border-dashed border-slate-300 rounded-xl p-6 flex flex-col items-center justify-center text-center bg-white hover:bg-blue-50 hover:border-primary/50 transition-all cursor-pointer h-40">
                            <span
            ...
            <div class="p-8 border-t border-slate-200 bg-white flex flex-col-reverse sm:flex-row justify-end gap-4">
                ...
                <BaseButton v-else variant="secondary" type="button">
                   Simpan Draft
                </BaseButton>
